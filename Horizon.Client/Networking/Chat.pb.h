...
class ChatPacket :
 ...
 public:
  ...
  inline ChatPacket* New() const final {
    return CreateMaybeMessage<ChatPacket>(nullptr);
  }

  ChatPacket* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline void ChatPacket::set_message(std::string&& value) {
  
  message_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:ChatPacket.Message)
}
inline void ChatPacket::set_message(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  message_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:ChatPacket.Message)
}
inline void ChatPacket::set_message(const char* value, size_t size) {
  
  message_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:ChatPacket.Message)
}
